                            ...
                            <tr>
                                ...
                                @foreach($rols as $id => $nombre)
                                    <td class="text-center">
                                        ...
                                        name="menu_rol[]"
                                        data-menuid={{$menu[ "id"]}}
                                        value="{{$id}}" {{in_array($id, array_column($menuRols[$menu["id"]], "id"))? "checked" : ""}}>
                                    </td>
                                @endforeach
                            </tr>
                                ...
                                <tr>
                                    ...
                                    @foreach($rols as $id => $nombre)
                                        <td class="text-center">
                                            ...
                                            name="menu_rol[]"
                                            data-menuid={{$hijo[ "id"]}}
                                            value="{{$id}}" {{in_array($id, array_column($menuRols[$hijo["id"]], "id"))? "checked" : ""}}>
                                        </td>
                                    @endforeach
                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        @foreach($rols as $id => $nombre)
                                            <td class="text-center">
                                                ...
                                                value="{{$id}}" {{in_array($id, array_column($menuRols[$hijo2["id"]], "id"))? "checked" : ""}}>
                                            </td>
                                        @endforeach
                                    </tr>
                                    @foreach ($hijo2["submenu"] as $key => $hijo3)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                value="{{$id}}" {{in_array($id, array_column($menuRols[$hijo3["id"]], "id"))? "checked" : ""}}>
                                            </td>
                                            @endforeach
                                        </tr>
                                    @endforeach
